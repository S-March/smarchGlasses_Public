 ...
 ****************************************************************************************
 */ 
 #define USING_DEV_KIT 0
 #define LED_ON_TIME 100 //Value*10 is milliseconds
...
#else
    #define GPIO_INT_PORT           GPIO_PORT_0
    #define GPIO_INT_PIN            GPIO_PIN_9
#endif
